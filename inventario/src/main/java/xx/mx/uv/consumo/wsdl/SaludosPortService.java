 ...
 * 
 */
@WebServiceClient(name = "saludosPortService", targetNamespace = "t4is.uv.mx/saludos", wsdlLocation = "https://facturasbasefinal-production.up.railway.app/ws/facturas.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://facturasbasefinal-production.up.railway.app/ws/facturas.wsdl");
